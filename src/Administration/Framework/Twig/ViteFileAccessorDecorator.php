...
namespace Shopwell\Administration\Framework\Twig;
...
class ViteFileAccessorDecorator extends FileAccessor
{
     ...
     * @return array<string, mixed>
     */
    public function getBundleData(ShopwellBundle $bundle): array
    {
    ...
    private function getTechnicalBundleName(ShopwellBundle $bundle): string
    {
     ...
     * @return array<string, mixed>
     */
    private function getContent(string $fileType, ShopwellBundle $bundle): array
    {
