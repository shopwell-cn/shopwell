...
module.exports = {
    ...
    preset: '@shopwell-ag/jest-preset-sw6-admin',
    globals: {
    ...
    moduleNameMapper: {
        ...
        '^@shopwell-ag/meteor-component-library$': '<rootDir>/node_modules/@shopwell-ag/meteor-component-library/dist/common/index.js',
        '^@shopwell-ag/meteor-component-library/dist/esm/(.*)$': '<rootDir>/node_modules/@shopwell-ag/meteor-component-library/dist/common/$1',
    ...
    reporters: isCi ? [
        ...
        ['jest-junit', {
            suiteName: 'Shopwell 6 Unit Tests',
