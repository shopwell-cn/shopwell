...
import type ShopwellDiscountCampaignService from './app/service/discount-campaign.service';
...
import type { ShopwellExtensionsStore } from './module/sw-extension/store/extensions.store';
...
declare global {
    ...
    interface CustomShopwellProperties {}

    interface CustomShopwellConstants {
    ...
    /**
     * Make the Shopwell object globally available
     */
    const Shopwell: ShopwellClass & CustomShopwellProperties;
    ...
    interface Window {
        Shopwell: ShopwellClass & CustomShopwellProperties;
        _features_: {
    ...
    /**
     * @see Shopwell\Core\Framework\Api\EventListener\ErrorResponseFactory
     */
    interface ShopwellHttpError {
        code: string;
        status: string;
        title: string;
        detail: string;
        meta?: {
            ...
            parameters?: object;
            previous?: ShopwellHttpError;
        };
        trace?: { [key: string]: string };
    }

    interface ShopwellErrorMeta {
        parameters: {
            dependency: string;
    ...
    interface ShopwellError {
        code: string;
        meta: ShopwellErrorMeta;
    }

    interface ShopwellApiError {
        response: {
            data: {
                errors: ShopwellError[];
            };
        };
    }

    interface StoreApiException extends ShopwellHttpError {
        meta?: ShopwellHttpError['meta'] & {
