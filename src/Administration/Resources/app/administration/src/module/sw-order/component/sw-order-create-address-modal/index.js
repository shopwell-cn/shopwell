...
const { Mixin, Store, Service } = Shopwell;
    ...
    methods: {
        ...
        async getCustomerAddresses() {
            ...
            try {
                ...
                await Shopwell.Store.get('error').resetApiErrors();
            } catch {
        ...
        async saveCurrentAddress() {
            ...
            if (!this.isValidCompanyField) {
                const companyError = new Shopwell.Classes.ShopwellError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });

                await Shopwell.Store.get('error').addApiError({
