    ...
    methods: {
        ...
        setEmailTemplateAccordingToDocumentType() {
            ...
            this.mailTemplateRepository
                .search(this.mailTemplateCriteria, { ...Shopwell.Context.api, languageId: this.order.languageId })
                .then((result) => {
        ...
        onSendDocument() {
            ...
            const apiContext = {
                ...
                languageId: this.order.languageId || Shopwell.Context.api.languageId,
            };
