...
const { Store, Utils, Data, Service, Mixin } = Shopwell;
const { Criteria } = Data;
...
export default {
    ...
    methods: {
        ...
        async onSelectExistingCustomer(customerId) {
            ...
            try {
                const customer = await this.customerRepository.get(customerId, Shopwell.Context.api, this.defaultCriteria);
        ...
        setCustomerAddress({ contextId, data }) {
            ...
            this.customerAddressRepository
                .get(data.id, Shopwell.Context.api, this.customerAddressCriteria)
                .then((updatedAddress) => {
