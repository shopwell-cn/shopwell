...
describe('src/module/sw-order/state/order-detail.store', () => {
    const state = Shopwell.Store.get('swOrderDetail');
    ...
    it('should be able to setLoading', () => {
        ...
        expect(Shopwell.Store.get('swOrderDetail').isLoading).toBe(true);
    });
    ...
    it('should be able to setEditing', () => {
        Shopwell.Store.get('swOrderDetail').editing = true;

        expect(state.editing).toBe(true);
        expect(Shopwell.Store.get('swOrderDetail').isEditing).toBe(true);
    });
    ...
    it('should set order address ids when provided valid address info', () => {
        ...
        Shopwell.Store.get('swOrderDetail').setOrderAddressIds(addressIdInfo);
    ...
    it('should update customerAddressId when orderAddressId and type match', () => {
        ...
        Shopwell.Store.get('swOrderDetail').setOrderAddressIds(initialAddressIdInfo);
        Shopwell.Store.get('swOrderDetail').setOrderAddressIds(updatedAddressIdInfo);
    ...
    it('should remove order address id when orderAddressId equals customerAddressId and type match', () => {
        ...
        Shopwell.Store.get('swOrderDetail').setOrderAddressIds(removalAddressIdInfo);
        expect(state.orderAddressIds).toEqual([]);
    });
});
