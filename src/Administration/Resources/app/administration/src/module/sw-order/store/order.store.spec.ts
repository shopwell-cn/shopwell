...
describe('src/module/sw-order/store/order.store', () => {
    const store = Shopwell.Store.get('swOrder');
    ...
    beforeAll(() => {
        ...
        // eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
        Shopwell.Service().register('checkoutStoreService', () => {
            return {
                checkout: checkoutMock,
            } as unknown as CheckoutStoreService;
        });
        // eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
        Shopwell.Service().register('orderStateMachineService', () => {
            return {
    ...
    beforeEach(() => {
        Shopwell.Store.get('swOrder').$reset();
    });
