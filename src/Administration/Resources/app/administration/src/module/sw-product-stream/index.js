...
Shopwell.Component.register('sw-product-stream-list', () => import('./page/sw-product-stream-list'));
Shopwell.Component.register('sw-product-stream-detail', () => import('./page/sw-product-stream-detail'));
Shopwell.Component.register('sw-product-stream-field-select', () => import('./component/sw-product-stream-field-select'));
Shopwell.Component.register('sw-product-stream-value', () => import('./component/sw-product-stream-value'));
Shopwell.Component.register('sw-product-stream-modal-preview', () => import('./component/sw-product-stream-modal-preview'));
