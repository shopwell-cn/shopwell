...
Shopwell.Component.register('sw-settings-currency-list', () => import('./page/sw-settings-currency-list'));
Shopwell.Component.register('sw-settings-currency-detail', () => import('./page/sw-settings-currency-detail'));
Shopwell.Component.register('sw-settings-price-rounding', () => import('./component/sw-settings-price-rounding'));
