...
export default Shopwell.Component.wrapComponentConfig({
    ...
    computed: {
        module() {
            return Shopwell.Store.get('extensionSdkModules').modules.find((module) => module.id === this.id);
        },
        ...
        smartBarButtons() {
            return Shopwell.Store.get('extensionSdkModules').smartBarButtons.filter(
