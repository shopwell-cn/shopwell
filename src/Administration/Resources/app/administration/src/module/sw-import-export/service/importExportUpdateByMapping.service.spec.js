    ...
    beforeAll(() => {
        Object.entries(entitySchemaMock).forEach(
            ([
                ...
                Shopwell.EntityDefinition.add(entityName, entityDefinition);
            },
        );

        importExportUpdateByMappingService = new ImportExportUpdateByMappingService(Shopwell.EntityDefinition);
    });
