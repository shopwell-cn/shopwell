...
const { debounce, get, flow } = Shopwell.Utils;
...
export default {
    ...
    computed: {
        ...
        actualPathPrefix() {
            ...
            this.actualPathParts.forEach((part) => {
                ...
                const definition = Shopwell.EntityDefinition.get(entity);
        ...
        currentEntity() {
            ...
            let actualDefinition = Shopwell.EntityDefinition.get(this.entityType);
            ...
            pathParts.forEach((propertyName) => {
                ...
                entityFound = Shopwell.EntityDefinition.has(entity);

                if (entityFound) {
                    actualDefinition = Shopwell.EntityDefinition.get(entity);
                }
            });
    ...
    methods: {
        getDefinition(isCustomField) {
            ...
            const definition = Shopwell.EntityDefinition.get(this.currentEntity);
        ...
        propertyFilter(property) {
            ...
            if (property.type === 'association') {
                const subEntity = Shopwell.EntityDefinition.get(property.entity);
        ...
        processTranslations({ definition, options, properties, path }) {
            ...
            const translationDefinition = Shopwell.EntityDefinition.get(translationProperty.entity);
        ...
        processTransactions({ definition, options, properties, path }) {
            ...
            const transactionDefinition = Shopwell.EntityDefinition.get(transactionsProperty.entity);
        ...
        processDeliveries({ definition, options, properties, path }) {
            ...
            const deliveryDefinition = Shopwell.EntityDefinition.get(deliveryProperty.entity);
