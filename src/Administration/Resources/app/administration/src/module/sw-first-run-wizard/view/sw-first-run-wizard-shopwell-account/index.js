import template from './sw-first-run-wizard-shopwell-account.html.twig';
import './sw-first-run-wizard-shopwell-account.scss';
...
export default {
    ...
    methods: {
        ...
        setTitle() {
            this.$emit('frw-set-title', this.$tc('sw-first-run-wizard.shopwellAccount.modalTitle'));
        },
        ...
        testCredentials() {
            const { shopwellId, password } = this;
            ...
            return this.firstRunWizardService
                ...
                .then(() => {
                    ...
                    this.$emit('frw-redirect', 'sw.first.run.wizard.index.shopwell.domain');
