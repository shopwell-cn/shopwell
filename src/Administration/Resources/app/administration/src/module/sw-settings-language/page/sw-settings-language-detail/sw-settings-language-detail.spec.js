...
describe('module/sw-settings-language/page/sw-settings-language-detail', () => {
    ...
    it('should not be possible to inherit with no system language', async () => {
        ...
        wrapper.vm.language = {
            id: Shopwell.Context.api.systemLanguageId,
        };
    ...
    it('should load entity data', async () => {
        const wrapper = await createWrapper([], Shopwell.Context.api.systemLanguageId);
        expect(wrapper.vm.languageId).toBe(Shopwell.Context.api.systemLanguageId);
        await flushPromises();

        expect(wrapper.vm.language.id).toBe(Shopwell.Context.api.systemLanguageId);
    });
    ...
    it('should add an asterix to used iso codes', async () => {
        const wrapper = await createWrapper(['language.editor'], Shopwell.Context.api.systemLanguageId, false);
        await flushPromises();
