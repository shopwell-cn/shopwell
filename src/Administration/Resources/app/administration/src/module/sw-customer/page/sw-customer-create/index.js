...
export default {
    ...
    watch: {
        ...
        'customer.accountType'(value) {
            ...
            Shopwell.Store.get('error').removeApiError(`customer_address.${this.address.id}.company`);
        },
    },
    ...
    methods: {
            ...
            return this.customerValidationService
                ...
                .catch((exception) => {
                    Shopwell.Store.get('error').addApiError({
                        ...
                        error: new ShopwellError(exception.response.data.errors[0]),
                    });
                });
        },
        ...
        async onSave() {
            ...
            const context = { ...Shopwell.Context.api, ...{ languageId } };
        ...
        async loadLanguage(salesChannelId) {
            const languageId = Shopwell.Context.api.languageId;
