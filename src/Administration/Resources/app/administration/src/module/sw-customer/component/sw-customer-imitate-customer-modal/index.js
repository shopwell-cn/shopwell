...
export default {
    ...
    computed: {
        ...
        salesChannelDomainCriteria() {
            ...
            criteria.addFilter(Criteria.equals('salesChannel.typeId', Shopwell.Defaults.storefrontSalesChannelTypeId));
    ...
    methods: {
        ...
        fetchSalesChannelDomains() {
            this.salesChannelDomainRepository
                .search(this.salesChannelDomainCriteria, Shopwell.Context.api)
                .then((loadedDomains) => {
