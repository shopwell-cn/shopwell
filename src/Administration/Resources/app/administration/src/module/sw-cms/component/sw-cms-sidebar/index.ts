...
export default Shopwell.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        demoContext() {
            if (this.demoEntity === 'product') {
                return { ...Shopwell.Context.api, inheritance: true };
            }
    ...
    methods: {
        ...
        openSectionSettings(sectionIndex: number) {
            Shopwell.Store.get('cmsPage').setSection(this.page.sections![sectionIndex]);
        ...
        onSectionDelete(sectionId: string) {
            Shopwell.Store.get('cmsPage').removeSelectedSection();
        ...
        onBlockDelete(block: Entity<'cms_block'>, section: Entity<'cms_section'> | null) {
            ...
            if (this.selectedBlock && this.selectedBlock.id === block.id) {
                Shopwell.Store.get('cmsPage').removeSelectedBlock();
            }
