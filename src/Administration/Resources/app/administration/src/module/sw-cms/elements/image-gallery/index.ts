 ...
 */
Shopwell.Component.register('sw-cms-el-preview-image-gallery', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-config-image-gallery', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-image-gallery', () => import('./component'));
