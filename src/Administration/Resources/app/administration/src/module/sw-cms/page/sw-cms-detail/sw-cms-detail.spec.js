...
describe('module/sw-cms/page/sw-cms-detail', () => {
    ...
    it('should get preview entity for categories', async () => {
        ...
        const State = Shopwell.Store._rootState.state.value.cmsPage;
    ...
    it('should set the currentPageType in the cmsPage', async () => {
        ...
        let State = Shopwell.Store._rootState.state.value.cmsPage;
        ...
        State = Shopwell.Store._rootState.state.value.cmsPage;
    ...
    it('should reset all related stores', async () => {
        ...
        Shopwell.Store.get = jest.fn().mockImplementation((storeName) => {
            switch (storeName) {
                case 'cmsPage':
