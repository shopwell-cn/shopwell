...
const { Component, Mixin, Utils } = Shopwell;
const { mapPropertyErrors } = Component.getComponentHelper();
const { ShopwellError } = Shopwell.Classes;
const { debounce } = Shopwell.Utils;
const { cloneDeep, getObjectDiff } = Shopwell.Utils.object;
const { isEmpty } = Shopwell.Utils.types;
const { warn } = Shopwell.Utils.debug;
const { Criteria } = Shopwell.Data;
const { CMS } = Shopwell.Constants;
...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            const isSystemDefaultLanguage = Shopwell.Store.get('context').isSystemDefaultLanguage;
        ...
        async loadPage(pageId) {
            ...
            try {
                this.page = await this.pageRepository.get(pageId, Shopwell.Context.api, this.loadPageCriteria);
        ...
        onSaveEntity() {
            ...
            return this.pageRepository
                .save(this.page, Shopwell.Context.api, false)
                .then(() => {
                    this.isLoading = false;
        ...
        getError(property) {
            return Shopwell.Store.get('error').getApiError(this.page, property);
        },
        ...
        async setDefaultLayout() {
            ...
            const isLiveVersion = this.page.versionId === Shopwell.Context.api.liveVersionId;
