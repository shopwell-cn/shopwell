 ...
 */
Shopwell.Component.register('sw-cms-el-preview-buy-box', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-config-buy-box', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-buy-box', () => import('./component'));
...
Shopwell.Service('cmsService').registerCmsElement({
    ...
    defaultConfig: {
        product: {
            ...
            entity: {
                name: 'product',
                criteria: new Shopwell.Data.Criteria(1, 25).addAssociation('deliveryMedia'),
            },
        },
        alignment: {
            source: 'static',
