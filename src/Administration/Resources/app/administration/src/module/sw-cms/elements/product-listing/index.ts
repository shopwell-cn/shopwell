 ...
 */
Shopwell.Component.register('sw-cms-el-preview-product-listing', () => import('./preview'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-config-product-listing', () => import('./config'));
/**
 * @private
 * @sw-package discovery
 */
Shopwell.Component.register('sw-cms-el-product-listing', () => import('./component'));
/**
 * @private
 * @sw-package discovery
 */
