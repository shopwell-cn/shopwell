...
const selectedOrderId = Shopwell.Utils.createId();
...
describe('src/module/sw-bulk-edit/page/sw-bulk-edit-order', () => {
    ...
    beforeEach(async () => {
        ...
        Shopwell.Store.get('swBulkEdit').$reset();
        Shopwell.Store.get('swBulkEdit').selectedIds = [selectedOrderId];
    });
    ...
    it('should call fetchStatusOptions when component created', async () => {
        ...
        const { liveVersionId } = Shopwell.Context.api;
