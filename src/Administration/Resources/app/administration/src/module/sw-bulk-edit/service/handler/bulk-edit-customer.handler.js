...
class BulkEditCustomerHandler extends BulkEditBaseHandler {
    constructor() {
        ...
        this.entityIds = [];
        this.customerGroupRegistrationService = Shopwell.Service('customerGroupRegistrationService');
        this.customerRepository = Shopwell.Service('repositoryFactory').create('customer');
    }
