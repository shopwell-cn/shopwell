...
describe('src/module/sw-bulk-edit/page/sw-bulk-edit-product', () => {
    ...
    async function createWrapper(
        ...
        Shopwell.Store.get('swProductDetail').product = productEntity;
    ...
    beforeAll(async () => {
        ...
        Shopwell.Application.getContainer('factory').apiService.register('calculate-price', {
            calculatePrice: () => {
    ...
    it('should be selected taxRate on click change tax field', async () => {
        ...
        const taxId = Shopwell.Store.get('swProductDetail').product.taxId;
