...
const { Component, Mixin, Context } = Shopwell;
...
export default {
    ...
    methods: {
        loadConditionData() {
            const context = {
                ...Context.api,
                languageId: Shopwell.Store.get('session').languageId,
            };
            const criteria = new Criteria();
        ...
        onSave() {
            ...
            if (!this.validateDateRange()) {
                Shopwell.Store.get('error').addApiError({
                    ...
                    error: new Shopwell.Classes.ShopwellError({
        ...
        onChangeLanguage(languageId) {
            Shopwell.Store.get('context').api.languageId = languageId;
        ...
        onDuplicate() {
            return this.onSave().then(() => {
                ...
                return this.ruleRepository.clone(this.rule.id, behaviour, Shopwell.Context.api).then((duplicatedData) => {
                    this.$router.push({
                        name: 'sw.settings.rule.detail',
