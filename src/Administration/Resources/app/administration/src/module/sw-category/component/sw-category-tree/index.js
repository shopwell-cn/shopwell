...
export default {
    ...
    computed: {
        categoriesToDelete() {
            return Shopwell.Store.get('swCategoryDetail').categoriesToDelete;
        },
        ...
        disableContextMenu() {
            ...
            return this.currentLanguageId !== Shopwell.Context.api.systemLanguageId;
        },
    ...
    watch: {
        categoriesToDelete(value) {
            ...
            Shopwell.Store.get('swCategoryDetail').categoriesToDelete = undefined;
        },
    ...
    methods: {
        ...
        loadActiveCategory() {
            ...
            parentIds.forEach((id) => {
                const promise = this.categoryRepository
                    .get(id, Shopwell.Context.api, this.criteriaWithChildren)
                    .then((result) => {
                        this.addCategories([
                            result,
                            ...result.children,
        ...
        onUpdatePositions: Shopwell.Utils.debounce(function onUpdatePositions({ draggedItem, oldParentId, newParentId }) {
        ...
        async deleteCheckedItems(checkedItems) {
            ...
            await this.categoryRepository.syncDeleted(ids, Shopwell.Context.api);
        ...
        syncSiblings({ parentId }) {
            ...
            return this.categoryRepository
                ...
                .then(() => {
                    this.categoryRepository.get(parentId, Shopwell.Context.api, this.criteria).then((parent) => {
