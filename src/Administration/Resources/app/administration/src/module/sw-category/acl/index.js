        ...
        roles: {
            viewer: {
                privileges: [
                    ...
                    Shopwell.Service('privileges').getPrivileges('cms.viewer'),
            ...
            editor: {
                privileges: [
                    ...
                    Shopwell.Service('privileges').getPrivileges('media.creator'),
                    Shopwell.Service('privileges').getPrivileges('cms.editor'),
