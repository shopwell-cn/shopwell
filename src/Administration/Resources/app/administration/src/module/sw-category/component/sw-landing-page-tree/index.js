...
export default {
    ...
    computed: {
        landingPagesToDelete() {
            return Shopwell.Store.get('swCategoryDetail').landingPagesToDelete;
        },
    ...
    watch: {
        landingPagesToDelete(value) {
            ...
            Shopwell.Store.get('swCategoryDetail').landingPagesToDelete = undefined;
        },
    ...
    methods: {
        ...
        duplicateElement(contextItem) {
            ...
            this.landingPageRepository
                .clone(contextItem.id, behavior, Shopwell.Context.api)
                .then((clone) => {
