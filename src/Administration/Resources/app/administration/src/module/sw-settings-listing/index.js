...
Shopwell.Component.register('sw-settings-listing', () => import('./page/sw-settings-listing'));
Shopwell.Component.register('sw-settings-listing-option-base', () => import('./page/sw-settings-listing-option-base'));
