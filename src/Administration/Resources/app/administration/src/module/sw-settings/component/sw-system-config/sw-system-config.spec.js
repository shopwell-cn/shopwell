...
function createConfig() {
    const firstCardElements = [
        ...
        },
        {
            ...
            type: 'url',
            config: {
                defaultValue: 'https://www.shopwell.com',
                label: {
                    'en-GB': 'url field',
                },
            },
            _test: {
                defaultValueDom: 'www.shopwell.com',
                domValueCheck: (field, domValue) => {
                    expect(field.find('input').element.value).toBe(domValue);
                },
                afterValue: 'https://www.shopwell.de',
                afterValueDom: 'www.shopwell.de',
                childValue: 'https://www.child.shopwell.com',
                childValueDom: 'www.child.shopwell.com',
                changeValueFunction: async (field, afterValue) => {
                    // change input value
