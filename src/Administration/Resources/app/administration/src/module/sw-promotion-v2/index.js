...
Shopwell.Component.register('sw-promotion-discount-component', () => import('./component/sw-promotion-discount-component'));
Shopwell.Component.register('sw-promotion-v2-detail', () => import('./page/sw-promotion-v2-detail'));
Shopwell.Component.register('sw-promotion-v2-list', () => import('./page/sw-promotion-v2-list'));
Shopwell.Component.register('sw-promotion-v2-detail-base', () => import('./view/sw-promotion-v2-detail-base'));
Shopwell.Component.register('sw-promotion-v2-conditions', () => import('./view/sw-promotion-v2-conditions'));
Shopwell.Component.register('sw-promotion-detail-discounts', () => import('./view/sw-promotion-detail-discounts'));
