...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.mailTemplate = this.mailTemplateRepository.create(Shopwell.Context.api, utils.createId());
        },
        ...
        getMailTemplate() {
            return this.mailTemplateRepository
                .get(this.mailTemplate.id, Shopwell.Context.api, this.mailTemplateCriteria)
                .then((data) => {
