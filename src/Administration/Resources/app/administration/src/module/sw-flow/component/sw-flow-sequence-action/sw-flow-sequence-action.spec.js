...
Shopwell.Service().register('flowBuilderService', () => {
        ...
        }),
        {
            global: {
                ...
                provide: {
                    ...
                    flowBuilderService: Shopwell.Service('flowBuilderService'),
                },
            },
...
describe('src/module/sw-flow/component/sw-flow-sequence-action', () => {
    beforeEach(() => {
        ...
        Shopwell.Store.get('swFlow').setSequences(getSequencesCollection([{ ...sequenceFixture }]));
        Shopwell.Store.get('swFlow').triggerEvent = {
            data: {
                customer: '',
                order: '',
            },
            ...
            aware: [
                'Shopwell\\Core\\Framework\\Event\\CustomerAware',
                'Shopwell\\Core\\Framework\\Event\\OrderAware',
                'Shopwell\\Core\\Framework\\Event\\MailAware',
            ],
        };
        Shopwell.Store.get('swFlow').triggerActions = [
            {
    ...
    it('should able to add an action', async () => {
        ...
        const sequencesState = Shopwell.Store.get('swFlow').sequences;
    ...
    it('should show action list correctly', async () => {
        Shopwell.Store.get('swFlow').setSequences(getSequencesCollection(sequencesFixture));
    ...
    it('should able to remove action container', async () => {
        ...
        let sequencesState = Shopwell.Store.get('swFlow').sequences;
        ...
        sequencesState = Shopwell.Store.get('swFlow').sequences;
    ...
    it('should set error for single select if action name is empty', async () => {
        Shopwell.Store.get('swFlow').invalidSequences = ['2'];
    ...
    it('should remove error for after select an action name', async () => {
        ...
        let invalidSequences = Shopwell.Store.get('swFlow').invalidSequences;
        ...
        invalidSequences = Shopwell.Store.get('swFlow').invalidSequences;
    ...
    it('should correct label in set order state description', async () => {
        Shopwell.Store.get('swFlow').stateMachineState = [
            {
    ...
    it('should has actions from app flow actions in actions list', async () => {
        ...
        Shopwell.Store.get('swFlow').setAppActions([
            {
                label: 'Telegram send message',
                name: 'telegram.send.message',
                swIcon: 'regular-envelope',
