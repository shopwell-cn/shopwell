...
const { Utils, EntityDefinition } = Shopwell;
const { capitalizeString, camelCase, snakeCase } = Shopwell.Utils.string;
const { ACTION, ACTION_GROUP, ACTION_TYPE, CUSTOMER_GROUP, GENERAL_GROUP, ORDER_GROUP, TAG_GROUP } = Shopwell.Constants.FLOW;
