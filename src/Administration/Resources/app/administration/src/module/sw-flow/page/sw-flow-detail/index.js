...
const { Component, Mixin, Context, Store, Utils, Service } = Shopwell;
...
export default {
    ...
    methods: {
        ...
        getAppFlowAction() {
            return this.appFlowActionRepository.search(this.appFlowActionCriteria, Shopwell.Context.api).then((response) => {
            ...
            if (hasDocumentAction) {
                ...
                promises.push(
                    this.documentTypeRepository.search(this.documentTypeCriteria).then((data) => {
                        Shopwell.Store.get('swFlow').documentTypes = data;
                    }),
                );
            }
            ...
            if (hasMailSendAction) {
                ...
                promises.push(
                    this.mailTemplateRepository.search(this.mailTemplateIdsCriteria).then((data) => {
                        Shopwell.Store.get('swFlow').mailTemplates = data;
                    }),
                );
            }
            ...
            if (hasChangeCustomerGroup) {
                ...
                promises.push(
                    this.customerGroupRepository.search(this.customerGroupCriteria).then((data) => {
                        Shopwell.Store.get('swFlow').customerGroups = data;
                    }),
                );
            }
            ...
            if (hasSetCustomFieldAction) {
                promises.push(
                    this.customFieldSetRepository.search(this.customFieldSetCriteria).then((data) => {
                        Shopwell.Store.get('swFlow').customFieldSets = data;
                    }),
                );

                promises.push(
                    this.customFieldRepository.search(this.customFieldCriteria).then((data) => {
                        Shopwell.Store.get('swFlow').customFields = data;
                    }),
                );
            }
