...
const FlatTree = Shopwell.Helper.FlatTreeHelper;
...
export default {
    ...
    computed: {
        ...
        salesChannelFavoritesService() {
            return Shopwell.Service('salesChannelFavorites');
        },
    ...
    methods: {
        ...
        registerListener() {
            Shopwell.Utils.EventBus.on('sw-sales-channel-detail-sales-channel-change', this.loadEntityData);
            Shopwell.Utils.EventBus.on('sw-language-switch-change-application-language', this.loadEntityData);
            Shopwell.Utils.EventBus.on('sw-sales-channel-detail-base-sales-channel-change', this.openSalesChannelModal);
            Shopwell.Utils.EventBus.on('sw-sales-channel-list-add-new-channel', this.openSalesChannelModal);
        },

        destroyedComponent() {
            Shopwell.Utils.EventBus.off('sw-sales-channel-detail-sales-channel-change', this.loadEntityData);
            Shopwell.Utils.EventBus.off('sw-language-switch-change-application-language', this.loadEntityData);
            Shopwell.Utils.EventBus.off('sw-sales-channel-detail-base-sales-channel-change', this.openSalesChannelModal);
            Shopwell.Utils.EventBus.off('sw-sales-channel-list-add-new-channel', this.openSalesChannelModal);
        },
