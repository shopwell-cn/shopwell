...
const { Component, Mixin, Context, Defaults } = Shopwell;
const { Criteria } = Shopwell.Data;
const domUtils = Shopwell.Utils.dom;
    ...
    methods: {
        ...
        deleteSalesChannel(salesChannelId) {
            return this.salesChannelRepository
                ...
                .then(() => {
                    Shopwell.Utils.EventBus.emit('sw-sales-channel-detail-base-sales-channel-change');
        ...
        async createCategoriesCollection(criteria, collectionName) {
            this[collectionName] = await this.categoryRepository.search(criteria, Shopwell.Context.api);
        },
