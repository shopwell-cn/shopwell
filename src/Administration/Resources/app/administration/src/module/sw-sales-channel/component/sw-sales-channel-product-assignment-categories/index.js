...
export default {
    ...
    methods: {
        ...
        searchCategories(term) {
            return this.categoryRepository.search(this.categorySearchCriteria(term), Shopwell.Context.api);
        },
        ...
        getProductFromCategories(categories) {
            return this.productRepository.search(this.productCriteria(categories), Shopwell.Context.api);
        },
    },
};
