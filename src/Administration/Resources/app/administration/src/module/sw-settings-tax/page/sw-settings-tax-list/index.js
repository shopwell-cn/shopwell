...
export default {
    ...
    methods: {
        ...
        isShopwellDefaultTax(tax) {
            return this.$te(`global.tax-rates.${tax.name}`, 'en-GB');
        },

        getLabel(tax) {
            return this.isShopwellDefaultTax(tax) ? this.$tc(`global.tax-rates.${tax.name}`) : tax.name;
        },
        ...
        onChangeTaxProviderActive(taxProvider) {
            ...
            this.taxProviderRepository.save(taxProvider, Shopwell.Context.api).then(() => {
