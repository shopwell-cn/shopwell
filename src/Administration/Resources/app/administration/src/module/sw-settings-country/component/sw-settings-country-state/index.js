    ...
    methods: {
        ...
        onDeleteCountryStates() {
            ...
            return this.countryStateRepository
                .syncDeleted(countryStateIds, Shopwell.Context.api)
                .then(() => {
                    this.$refs.countryStateGrid.resetSelection();
                    this.refreshCountryStateList();
                })
        ...
        onAddCountryState() {
            this.currentCountryState = this.countryStateRepository.create(Shopwell.Context.api);
        },
        ...
        onClickCountryState(item) {
            ...
            const copy = this.countryStateRepository.create(Shopwell.Context.api, item.id);
            copy._isNew = false;
