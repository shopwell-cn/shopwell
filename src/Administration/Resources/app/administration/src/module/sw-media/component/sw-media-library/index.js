...
const { Mixin, Context, Feature } = Shopwell;
...
export default {
    ...
    methods: {
        createdComponent() {
            Shopwell.Utils.EventBus.on('sw-media-library-item-updated', this.refreshItem);
        ...
        beforeUnmountedComponent() {
            Shopwell.Utils.EventBus.off('sw-media-library-item-updated', this.refreshItem);
        },
