...
function getFileCollection(collection = []) {
    return new EntityCollection('/media', 'media', null, { isShopwellContext: true }, collection, collection.length, null);
}
...
describe('module/sw-product/component/sw-product-download-form', () => {
    ...
    beforeEach(() => {
        ...
        // Reset error state
        Shopwell.Store.get('error').system = {};
        Shopwell.Store.get('error').api = {};
    });
