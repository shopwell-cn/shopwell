...
describe('src/module/sw-extension/component/sw-extension-file-upload', () => {
    ...
    it('should throw an error if the upload goes wrong', async () => {
        ...
        expect(Object.keys(Shopwell.Store.get('notification').growlNotifications)).toHaveLength(0);
        ...
        await wrapper.vm.$nextTick();
        const growlNotifications = Shopwell.Store.get('notification').growlNotifications;
