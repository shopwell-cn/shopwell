...
Shopwell.Component.register('sw-extension-config', () => import('./page/sw-extension-config'));
Shopwell.Component.register('sw-extension-my-extensions-listing', () => import('./page/sw-extension-my-extensions-listing'));
Shopwell.Component.register('sw-extension-my-extensions-account', () => import('./page/sw-extension-my-extensions-account'));
Shopwell.Component.register('sw-extension-my-extensions-index', () => import('./page/sw-extension-my-extensions-index'));
Shopwell.Component.register('sw-extension-store-landing-page', () => import('./page/sw-extension-store-landing-page'));
...
Shopwell.Component.register('sw-extension-file-upload', () => import('./component/sw-extension-file-upload'));
Shopwell.Component.register(
    'sw-extension-permissions-details-modal',
    () => import('./component/sw-extension-permissions-details-modal'),
);
Shopwell.Component.register('sw-extension-card-base', () => import('./component/sw-extension-card-base'));
...
Shopwell.Component.register('sw-extension-permissions-modal', () => import('./component/sw-extension-permissions-modal'));
Shopwell.Component.register('sw-extension-domains-modal', () => import('./component/sw-extension-domains-modal'));
Shopwell.Component.register(
    'sw-extension-privacy-policy-extensions-modal',
    () => import('./component/sw-extension-privacy-policy-extensions-modal'),
);
Shopwell.Component.register('sw-extension-deactivation-modal', () => import('./component/sw-extension-deactivation-modal'));
Shopwell.Component.register('sw-extension-removal-modal', () => import('./component/sw-extension-removal-modal'));
Shopwell.Component.register('sw-extension-uninstall-modal', () => import('./component/sw-extension-uninstall-modal'));
Shopwell.Component.register('sw-extension-rating-stars', () => import('./component/sw-ratings/sw-extension-rating-stars'));
Shopwell.Component.register('sw-extension-ratings-card', () => import('./component/sw-ratings/sw-extension-ratings-card'));
Shopwell.Component.register(
    'sw-extension-ratings-summary',
    () => import('./component/sw-ratings/sw-extension-ratings-summary'),
);
Shopwell.Component.register('sw-extension-review', () => import('./component/sw-ratings/sw-extension-review'));
Shopwell.Component.register(
...
Shopwell.Component.register('sw-extension-review-reply', () => import('./component/sw-ratings/sw-extension-review-reply'));
Shopwell.Component.extend(
...
Shopwell.Component.register('sw-extension-adding-failed', () => import('./component/sw-extension-adding-failed'));
Shopwell.Component.register('sw-extension-adding-success', () => import('./component/sw-extension-adding-success'));
Shopwell.Component.register(
    'sw-extension-app-module-error-page',
    () => import('./component/sw-extension-app-module-error-page'),
);
Shopwell.Component.register('sw-extension-app-module-page', () => import('./page/sw-extension-app-module-page'));
 ...
 * @private
 */
Shopwell.Module.register('sw-extension', {
    type: 'core',
