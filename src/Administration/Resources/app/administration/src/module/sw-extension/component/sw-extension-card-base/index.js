...
export default {
    ...
    computed: {
        ...
        extensionMainModule() {
            return Shopwell.Store.get('extensionMainModules').mainModules.find(
        ...
        extensionManagementDisabled() {
            return Shopwell.Store.get('context').app.config.settings?.disableExtensionManagement;
        },
