...
Shopwell.Component.register('sw-plugin-box', () => import('./component/sw-plugin-box'));
Shopwell.Component.register(
    'sw-settings-payment-sorting-modal',
    () => import('./component/sw-settings-payment-sorting-modal'),
);
Shopwell.Component.register('sw-payment-card', () => import('./component/sw-payment-card'));
Shopwell.Component.register('sw-settings-payment-overview', () => import('./page/sw-settings-payment-overview'));
Shopwell.Component.register('sw-settings-payment-detail', () => import('./page/sw-settings-payment-detail'));
