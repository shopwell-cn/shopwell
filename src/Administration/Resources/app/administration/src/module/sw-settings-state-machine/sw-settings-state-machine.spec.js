...
describe('src/module/sw-settings-state-machine/index.js', () => {
    ...
    it('should add privilege mapping', () => {
        const privilegesMappings = Shopwell.Service('privileges').getPrivilegesMappings();
    ...
    it('should register module', () => {
        const module = Shopwell.Module.getModuleRegistry().get('sw-settings-state-machine');
