...
describe('module/sw-settings-shopwell-updates/page/sw-settings-shopwell-updates-wizard', () => {
    ...
    beforeEach(async () => {
        ...
        wrapper = mount(
            await wrapTestComponent('sw-settings-shopwell-updates-wizard', {
                sync: true,
            }),
            {
                global: {
                        ...
                        updateService: {
                            ...
                            checkRequirements: () =>
                                Promise.resolve([
                                    ...
                                    {
                                        name: 'validShopwellLicense',
                                        result: false,
                                        message: 'validShopwellLicense',
                                        vars: [],
                                        extensions: [],
                                    },
                                ]),
                    ...
                    stubs: {
                        ...
                        'sw-settings-shopwell-updates-requirements': await wrapTestComponent(
                            'sw-settings-shopwell-updates-requirements',
                        ),
                        'sw-data-grid': await wrapTestComponent('sw-data-grid'),
                        'sw-card-view': await wrapTestComponent('sw-card-view'),
                        'sw-ignore-class': true,
                        'sw-settings-shopwell-updates-info': {
                            template: '<div></div>',
                        },
                        'sw-settings-shopwell-updates-plugins': {
                            template: '<div></div>',
                        },
                        'sw-loader': {
                            template: '<div></div>',
