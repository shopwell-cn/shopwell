...
export default {
    ...
    computed: {
        ...
        unrestrictedPriceMatrixExists() {
            return Shopwell.Store.get('swShippingDetail').unrestrictedPriceMatrixExists;
        },

        newPriceMatrixExists() {
            return Shopwell.Store.get('swShippingDetail').newPriceMatrixExists;
        },

        defaultCurrency() {
            return Shopwell.Store.get('swShippingDetail').defaultCurrency;
        },
