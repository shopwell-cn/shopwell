...
describe('module/sw-settings-shipping/component/sw-settings-shipping-price-matrices', () => {
    ...
    beforeEach(async () => {
        Shopwell.Store.get('swShippingDetail').currencies = [
        ...
        const shippingMethod = Shopwell.Store.get('swShippingDetail').shippingMethod;
    ...
    it('should add the shipping price group', async () => {
        ...
        Shopwell.Store.get('swShippingDetail').shippingMethod.prices.add = (value) => {
            Shopwell.Store.get('swShippingDetail').shippingMethod.prices.push(value);
        };
