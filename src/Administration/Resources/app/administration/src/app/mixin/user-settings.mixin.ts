        ...
        methods: {
            ...
            getUserSettingsEntity(identifier: string, userId: string | null = null) {
                ...
                return this.userConfigRepository
                    .search(this.userGridSettingsCriteria(identifier, userId), Shopwell.Context.api)
                    .then((response) => {
                        if (!response.length) {
                            return null;
                        }
            ...
            async saveUserSettings(
                ...
                if (!userSettings) {
                    userSettings = this.userConfigRepository.create(Shopwell.Context.api);
                }
                ...
                return this.userConfigRepository.save(entityData, Shopwell.Context.api);
            },
            ...
            userGridSettingsCriteria(identifier: string, userId: string | null = null) {
                ...
                const criteria = new Shopwell.Data.Criteria(1, 25);
                criteria.addFilter(Shopwell.Data.Criteria.equals('key', identifier));
                criteria.addFilter(Shopwell.Data.Criteria.equals('userId', userId));
