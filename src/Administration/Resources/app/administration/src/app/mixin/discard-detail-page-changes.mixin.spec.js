...
async function createWrapper(...entityNames) {
    ...
    return mount(
        ...
        `,
            mixins: [
                Shopwell.Mixin.getByName('discard-detail-page-changes')(...entityNames),
            ],
            data() {
                return {
                    product: {
...
describe('src/app/mixin/discard-detail-page-changes.mixin.ts', () => {
    ...
    it('should log a warning when not entity with the name has a discard method was found', async () => {
        ...
        jest.spyOn(Shopwell.Utils.debug, 'warn').mockImplementationOnce(() => {});
        ...
        expect(Shopwell.Utils.debug.warn).toHaveBeenCalledWith(
