...
export default {
    ...
    computed: {
        ...
        defaultLocale() {
            const adminLocaleLanguage = Shopwell.Store.get('session').adminLocaleLanguage;
    ...
    methods: {
        ...
        getZeroValues() {
            ...
            const fromDate = Shopwell.Utils.format.dateWithUserTimezone();
            ...
            if (this.options.xaxis.max) {
                ...
                // get actual day
                const toDate = Shopwell.Utils.format.dateWithUserTimezone();
