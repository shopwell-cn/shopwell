...
export default {
        ...
        buttonConfig: {
            ...
            default() {
                return reactive([
                    {
                        type: 'paragraph',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.format'),
                        icon: 'regular-style-xs',
                        children: [
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.paragraph'),
                                value: 'p',
                                tag: 'p',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h1'),
                                value: 'h1',
                                tag: 'h1',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h2'),
                                value: 'h2',
                                tag: 'h2',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h3'),
                                value: 'h3',
                                tag: 'h3',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h4'),
                                value: 'h4',
                                tag: 'h4',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h5'),
                                value: 'h5',
                                tag: 'h5',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.h6'),
                                value: 'h6',
                                tag: 'h6',
                            },
                            {
                                type: 'formatBlock',
                                name: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.blockquote'),
                                value: 'blockquote',
                                tag: 'blockquote',
                            },
                        ],
                    ...
                    {
                        type: 'foreColor',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.text-color'),
                        value: '',
                        tag: 'font',
                    },
                    {
                        type: 'bold',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.bold'),
                        icon: 'regular-bold-xs',
                        tag: 'b',
                    },
                    {
                        type: 'italic',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.italic'),
                        icon: 'regular-italic-xs',
                        tag: 'i',
                    },
                    {
                        type: 'underline',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.underline'),
                        icon: 'regular-underline-xs',
                        tag: 'u',
                    },
                    {
                        type: 'strikethrough',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.strikethrough'),
                        icon: 'regular-strikethrough-xs',
                        tag: 'strike',
                    },
                    {
                        type: 'superscript',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.superscript'),
                        icon: 'regular-superscript-xs',
                        tag: 'sup',
                    },
                    {
                        type: 'subscript',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.subscript'),
                        icon: 'regular-subscript-xs',
                        tag: 'sub',
                    },
                    {
                        type: 'justify',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.textAlign'),
                        icon: 'regular-align-left-xs',
                        children: [
                            {
                                type: 'justifyLeft',
                                title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.alignLeft'),
                                icon: 'regular-align-left',
                            },
                            {
                                type: 'justifyCenter',
                                title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.alignCenter'),
                                icon: 'regular-align-center',
                            },
                            {
                                type: 'justifyRight',
                                title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.alignRight'),
                                icon: 'regular-align-right',
                            },
                            {
                                type: 'justifyFull',
                                title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.justify'),
                    ...
                    },
                    {
                        ...
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.insert-unordered-list'),
                        icon: 'regular-list-unordered-xs',
                        tag: 'ul',
                    },
                    {
                        type: 'insertOrderedList',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.insert-ordered-list'),
                        icon: 'regular-list-numbered-xs',
                        tag: 'ol',
                    },
                    {
                        type: 'link',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.link'),
                    ...
                    {
                        type: 'undo',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.undo'),
                        icon: 'regular-undo-xs',
                        position: 'middle',
                    },
                    {
                        type: 'redo',
                        title: Shopwell.Snippet.tc('sw-text-editor-toolbar.title.redo'),
    ...
    data() {
        return {
            ...
            isTableEdit: false,
            cmsPageState: Shopwell.Store.get('cmsPage'),
            minorElementTags: [
                '#text',
                'br',
                'b',
