...
export default {
    ...
    methods: {
        ...
        findUserSetting() {
            ...
            return this.userConfigRepository.search(this.userGridSettingCriteria, Shopwell.Context.api).then((response) => {
                if (!response.length) {
                    return;
                }
        ...
        findUserSettingById() {
            return this.userConfigRepository.get(this.currentSetting.id, Shopwell.Context.api).then((response) => {
                if (!response) {
                    return;
                }
        ...
        createUserGridSetting() {
            const newUserGrid = this.userConfigRepository.create(Shopwell.Context.api);
        ...
        saveUserSettings() {
            ...
            this.userConfigRepository.save(this.currentSetting, Shopwell.Context.api).then(() => {
