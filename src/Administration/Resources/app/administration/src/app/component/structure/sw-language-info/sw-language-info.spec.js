...
describe('src/app/component/structure/sw-language-info', () => {
    ...
    beforeEach(async () => {
        Shopwell.Store.get('context').api.languageId = '123456789';
        Shopwell.Store.get('context').api.systemLanguageId = 123456789;
    ...
    it('should not render the infoText when user is in default language', async () => {
        ...
        Shopwell.Store.get('context').api.languageId = '123';
        Shopwell.Store.get('context').api.systemLanguageId = '123';
    ...
    it('should render the infoText for a root language', async () => {
        Shopwell.Store.get('context').api.systemLanguageId = '987654312';
        Shopwell.Store.get('context').api.language = {
            id: '1a2b3c',
            parentId: null,
        };
