...
export default {
    ...
    computed: {
        ...
        languageCriteria() {
            ...
            criteria.addFilter(Criteria.equals('id', Shopwell.Context.api.systemLanguageId));
    ...
    methods: {
        async createdComponent() {
            ...
            this.snippetSets = await this.snippetSetRepository.search(new Criteria(), Shopwell.Context.api);
        ...
        async updatePlaceholderValueToSnippetTranslation() {
            ...
            const currentLocale = Shopwell.Store.get('session').currentLocale;
        ...
        async getSystemDefaultLocale() {
            const languages = await this.languageRepository.search(this.languageCriteria, Shopwell.Context.api);
