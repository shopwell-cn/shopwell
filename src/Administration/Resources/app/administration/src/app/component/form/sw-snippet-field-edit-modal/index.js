...
export default {
    ...
    computed: {
        ...
        currentAuthor() {
            return `user/${Shopwell.Store.get('session').currentUser.username}`;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.snippetSets.forEach((snippetSet) => {
                ...
                const snippet = this.snippetRepository.create(Shopwell.Context.api);
        ...
        onSave() {
            ...
            this.editableSnippets.forEach((snippet) => {
                ...
                if (snippet.origin !== snippet.value) {
                    ...
                    responses.push(this.snippetRepository.save(snippet, Shopwell.Context.api));
                    ...
                    responses.push(this.snippetRepository.delete(snippet.id, Shopwell.Context.api));
                }
            });
