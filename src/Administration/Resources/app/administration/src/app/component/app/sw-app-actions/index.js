...
export default {
    ...
    computed: {
        ...
        params() {
            return Shopwell.Store.get('shopwellApps').selectedIds;
        },
    ...
    methods: {
        ...
        getUserConfig() {
            this.userConfigRepository.search(this.userConfigCriteria, Shopwell.Context.api).then((response) => {
                if (response.length) {
                    this.iframeUserConfig = response.first();
                } else {
                    this.iframeUserConfig = this.userConfigRepository.create(Shopwell.Context.api);
        ...
        saveConfig(value) {
            ...
            this.userConfigRepository.save(this.iframeUserConfig, Shopwell.Context.api).then(() => {
                this.getUserConfig();
            });
        },
    },
