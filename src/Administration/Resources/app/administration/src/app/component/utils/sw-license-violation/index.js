...
export default {
    ...
    computed: {
        violations() {
            return Shopwell.Store.get('licenseViolation').violations;
        },

        warnings() {
            return Shopwell.Store.get('licenseViolation').warnings;
        },
        ...
        pluginCriteria() {
            return new Shopwell.Data.Criteria(1, 50);
        },
        ...
        getPluginViolation() {
            ...
            return this.licenseViolationService
                ...
                .then(({ violations, warnings, other }) => {
                    const licenseViolationStore = Shopwell.Store.get('licenseViolation');
