...
describe('sw-app-wrong-app-url-modal', () => {
    ...
    beforeAll(() => {
        ...
        removeNotificationSpy = jest.spyOn(Shopwell.Store.get('notification'), 'removeNotification');
    });

    it('should show modal', async () => {
        Shopwell.Store.get('context').app.config.settings.appUrlReachable = false;
        Shopwell.Store.get('context').app.config.settings.appsRequireAppUrl = true;
    ...
    it('should not show modal if no apps are require app url, but it should show notification', async () => {
        Shopwell.Store.get('context').app.config.settings.appUrlReachable = false;
        Shopwell.Store.get('context').app.config.settings.appsRequireAppUrl = false;
        localStorage.removeItem(STORAGE_KEY_WAS_WRONG_APP_MODAL_SHOWN);
