...
describe('components/form/sw-url-field', () => {
    ...
    it('properly detects SSL', async () => {
        const SSL_URL = 'https://shopwell.com';
        const NON_SSL_URL = 'http://shopwell.com';
        const URL_WITHOUT_PROTOCOL = 'shopwell.com';
    ...
    it('removes any protocol', async () => {
        const HTTP_URL = 'http://shopwell.com';
        const HTTPS_URL = 'https://shopwell.com';
        const FILE_URL = 'file://shopwell.com';
        const EXPECTED_URL = 'shopwell.com';
    ...
    it('allows empty values', async () => {
        const INITIAL_URL = 'https://shopwell.com';
        const URL_WITHOUT_PROTOCOL = 'shopwell.com';
        const EXPECTED_URL = '';
    ...
    it('should update empty values', async () => {
        ...
        expect(input.element.value).toBe('shopwell.com');
    ...
    it('adds the trailing slash if the prop is set', async () => {
        ...
        await input.setValue('shopwell.com');
        await input.trigger('blur');
        await nextTick();
        expect(wrapper.vm.currentUrlValue).toBe('shopwell.com/');
        expect(wrapper.emitted('update:value')).toStrictEqual([
            ['https://shopwell.com/'],
        ]);
    });
