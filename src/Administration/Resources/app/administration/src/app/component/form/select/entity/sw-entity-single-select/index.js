...
const { debounce, get } = Shopwell.Utils;
...
export default {
    ...
    props: {
        ...
        entityCreationLabel: {
            ...
            required: false,
            default() {
                return Shopwell.Snippet.tc('global.sw-single-select.labelEntity');
            },
        },
        ...
        createNewEntity() {
            ...
            this.repository
                ...
                .catch(() => {
                    ...
                    Shopwell.Utils.debug.error('Only Entities with "name" as the only required field are creatable.');
                    this.isLoading = false;
                });
        },
