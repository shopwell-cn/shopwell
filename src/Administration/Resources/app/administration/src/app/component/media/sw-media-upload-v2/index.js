...
const { fileReader } = Shopwell.Utils;
const { fileSize } = Shopwell.Utils.format;
...
export default {
    ...
    data() {
        return {
            ...
            isUploadUrlFeatureEnabled: Shopwell.Store.get('context').app.config?.settings?.enableUrlFeature ?? false,
            isLoading: false,
        };
    },
