...
export default {
    ...
    computed: {
        ...
        systemLanguageId() {
            return Shopwell.Store.get('context').api.systemLanguageId;
        },
    ...
    methods: {
        async refreshParentLanguage() {
            ...
            if (this.language.parentId !== null && this.language.parentId.length > 0) {
                this.parentLanguage = await this.languageRepository.get(this.language.parentId, Shopwell.Context.api);
                return;
            }

            this.parentLanguage = await this.languageRepository.get(this.systemLanguageId, Shopwell.Context.api);
        },
        ...
        onClickParentLanguage() {
            ...
            Shopwell.Utils.EventBus.emit('on-change-language-clicked', this.parentLanguage.id);
        },
    },
};
