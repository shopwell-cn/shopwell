...
const { Context, Mixin, Filter } = Shopwell;
    ...
    methods: {
        ...
        async updateSuccessNotification(successAmount, failureAmount, totalAmount) {
            ...
            if (this.notificationId !== null) {
                await Shopwell.Store.get('notification').updateNotification({
            ...
            const newNotificationId = await Shopwell.Store.get('notification').createNotification({
                variant: 'success',
                ...notification,
            });
