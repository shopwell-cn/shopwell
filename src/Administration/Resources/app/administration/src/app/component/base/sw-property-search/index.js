    ...
    methods: {
        ...
        showSearch() {
            ...
            this.propertyGroupOptionRepository
                .search(this.propertyGroupOptionCriteria, Shopwell.Context.api)
                .then((groupOptions) => {
        ...
        loadGroups() {
            this.propertyGroupRepository.search(this.propertyGroupCriteria, Shopwell.Context.api).then((groups) => {
                this.groups = groups;
