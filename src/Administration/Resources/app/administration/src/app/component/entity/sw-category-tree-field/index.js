...
export default {
    ...
    methods: {
        ...
        getTreeItems(parentId = null) {
            ...
            return this.globalCategoryRepository.search(criteria, Shopwell.Context.api).then((searchResult) => {
        ...
        searchCategories(term) {
            ...
            // search for categories
            return this.globalCategoryRepository.search(categorySearchCriteria, Shopwell.Context.api);
        },
