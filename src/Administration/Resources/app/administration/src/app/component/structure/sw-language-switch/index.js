...
export default {
    ...
    methods: {
        createdComponent() {
            this.languageId = Shopwell.Context.api.languageId;
            this.lastLanguageId = this.languageId;

            Shopwell.Utils.EventBus.on('on-change-language-clicked', this.changeToNewLanguage);
        },

        destroyedComponent() {
            Shopwell.Utils.EventBus.off('on-change-language-clicked', this.changeToNewLanguage);
        },
        ...
        emitChange() {
            ...
            if (this.changeGlobalLanguage) {
                ...
                Shopwell.Utils.EventBus.emit('sw-language-switch-change-application-language', {
