...
export default {
    ...
    methods: {
        ...
        addEventListeners() {
            ...
            Shopwell.Utils.EventBus.on('item-select', this.onItemSelect);
        },
        ...
        removeEventListeners() {
            ...
            Shopwell.Utils.EventBus.off('item-select', this.onItemSelect);
        },
        ...
        emitActiveItemIndex(shouldFocus = false) {
            ...
            Shopwell.Utils.EventBus.emit('active-item-change', this.activeItemIndex, {
                shouldFocus,
            });
        },
        ...
        emitClicked() {
            ...
            Shopwell.Utils.EventBus.emit('item-select-by-keyboard', this.activeItemIndex);
        },
