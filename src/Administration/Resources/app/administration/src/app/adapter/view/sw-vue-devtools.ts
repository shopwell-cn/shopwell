 ...
 * @private
 */
export default function setupShopwellDevtools(app: App): void {
    setupDevtoolsPlugin(
        {
            // Options
            id: 'sw-admin-extension-plugin',
            label: 'Shopwell Admin extensions plugin',
        ...
        `;
            ...
            api.on.getInspectorTree((payload) => {
                ...
                const publishedDatasets = Shopwell.ExtensionAPI.getPublishedDataSets();
            ...
            api.on.getInspectorState((payload) => {
                ...
                if (payload.nodeId.startsWith(DATASET_ID_PREFIX)) {
                    ...
                    const value =
                        Shopwell.ExtensionAPI.getPublishedDataSets().find((set) => set.id === datasetId)?.data ?? 'unknown';
