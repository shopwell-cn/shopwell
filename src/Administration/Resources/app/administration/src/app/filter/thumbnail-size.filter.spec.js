...
describe('src/app/filter/thumbnail-size.filter.ts', () => {
    const thumbnailSizeFilter = Shopwell.Filter.getByName('thumbnailSize');
    const mediaThumbnailFactory = Shopwell.Service('repositoryFactory').create('media_thumbnail_size');
