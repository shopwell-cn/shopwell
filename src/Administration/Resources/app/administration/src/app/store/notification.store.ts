...
export function initializeUserNotifications() {
    if (Shopwell.Store) {
        Shopwell.Store.get('notification').notifications = getNotificationsForUser();
    }
}
...
function _getStorageKey() {
    const user = Shopwell.Store.get('session').currentUser;
...
const notificationStore = Shopwell.Store.register({
    id: 'notification',
