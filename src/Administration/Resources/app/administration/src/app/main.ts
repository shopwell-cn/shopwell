...
Application.addServiceProvider('feature', () => {
    ...
    .addServiceProvider('loginService', () => {
        ...
        const loginService = LoginService(initContainer.httpClient, Shopwell.Context.api);
    ...
    .addServiceProvider('productTypeService', () => {
        ...
        return new ProductTypeApiService(initContainer.httpClient, Shopwell.Service('loginService'));
    })
    ...
    .addServiceProvider('localeHelper', () => {
        return new LocaleHelperService({
            Shopwell: Shopwell,
            localeRepository: Shopwell.Service('repositoryFactory').create('locale'),
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
            snippetService: Shopwell.Service('snippetService'),
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    ...
    .addServiceProvider('filterService', () => {
        return new FilterService({
            userConfigRepository: Shopwell.Service('repositoryFactory').create('user_config'),
        });
    })
    ...
    .addServiceProvider('appAclService', () => {
        return new AppAclService({
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
            privileges: Shopwell.Service('privileges'),
            appRepository: Shopwell.Service('repositoryFactory').create('app'),
        });
    })
