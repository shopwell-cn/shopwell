...
Shopwell.Service().register('userConfigService', () => {
    return {
...
Shopwell.Service().register('systemConfigApiService', () => {
    return {
...
describe('app/service/search-ranking.service.js', () => {
    ...
    function createModules(modules) {
        modules.forEach((module) => {
            Shopwell.Module.register(module.name, module);
        });
    }
    ...
    function addDataToRegisterUserConfigService(userConfigSearchs) {
        ...
        Shopwell.Service('userConfigService').search = () => Promise.resolve({ data });
    }
    ...
    it('should get minSearchTermLength from config', async () => {
        const originalService = Shopwell.Service('systemConfigApiService');
