...
describe('src/app/init/tabs.init', () => {
    ...
    beforeAll(() => {
        ...
        // Mock component
        Shopwell.Application.view.getComponent = () => ({});

        // Mock router factory
        Shopwell.Application.addInitializer('router', () => {
            return new Shopwell.Classes._private.RouterFactory(
                undefined,
                undefined,
                Shopwell.Application.getContainer('factory').module,
            );
        });
        ...
        Shopwell.Application.view.router = routerMock;

        // Add module to registry for receiving meta data
        Shopwell.Module.register('sw-category', {
            type: 'core',
            name: 'category',
        ...
        Shopwell.Module.register('sw-settings-usage-data', {
            type: 'core',
            name: 'usage-data',
    ...
    it('should initialize tab extension API correctly', async () => {
        ...
        expect(Shopwell.Store.get('tabs').tabItems).toHaveProperty('foo-position-id');
        expect(Shopwell.Store.get('tabs').tabItems['foo-position-id']).toEqual([
            {
                label: 'My tab item',
                componentSectionId: 'foo-component-section-id',
            },
    ...
    it('should create correct route entry for tab item when route gets opened (dynamic route)', async () => {
        ...
        // initialize view
        await Shopwell.Application._resolveViewInitialized();
