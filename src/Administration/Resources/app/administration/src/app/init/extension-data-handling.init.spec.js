...
describe('src/app/init/extension-data-handling.init.ts', () => {
    ...
    beforeAll(() => {
        jest.spyOn(Shopwell.Service('repositoryFactory'), 'create').mockImplementation((entityName) => {
    ...
    beforeEach(() => {
        Shopwell.Service('repositoryFactory').create.mockClear();
    ...
    it('should handle repositorySearch', async () => {
        ...
        expect(Shopwell.Service('repositoryFactory').create).toHaveBeenCalledWith('product');
