...
interface DragConfig<DATA = unknown> {
    ...
    onDragEnter:
        | null
        | ((dragConfigData: DragConfig<DATA>['data'], dropConfigData: DropConfig<DATA>['data'], valid?: boolean) => void);
 ...
 */
Shopwell.Directive.register('draggable', {
 ...
 */
Shopwell.Directive.register('droppable', {
