...
export default function createRouter(Router, View, moduleFactory, LoginService) {
    ...
    function addGlobalNavigationGuard(router) {
        ...
        router.beforeEach((to) => {
            ...
            const tokenHandler = new Shopwell.Helper.RefreshTokenHelper();
            ...
            if (to.meta.privilege && !Shopwell.Service('acl').can(to.meta.privilege)) {
    ...
    function convertRouteComponentToViewComponent(route) {
        const hasOwnProperty = Shopwell.Utils.object.hasOwnProperty;
    ...
    function getViewComponent(componentName) {
        return Shopwell.Application.view.getComponentForRoute(componentName);
    }

    function getAssetPath() {
        return Shopwell.Context.api.assetsPath;
    }
