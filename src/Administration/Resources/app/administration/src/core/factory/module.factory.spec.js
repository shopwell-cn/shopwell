...
const { Module, Application } = Shopwell;
...
describe('core/factory/module.factory.js', () => {
    ...
    it('should be possible to register a module with multiple navigation entries', () => {
        ...
        expect(externalLinkNavigation.link).toBe('http://de.shopwell.com');
    });
    ...
    it('should add settings item if feature flag is active', () => {
        ...
        expect(Shopwell.Store.get('settingsItems').settingsGroups).toEqual(expectedSettingsItem);
    });
    ...
    it('should not add settings item if feature flag is deactivated', () => {
        ...
        expect(Shopwell.Store.get('settingsItems').settingsGroups).toEqual({});
    });
