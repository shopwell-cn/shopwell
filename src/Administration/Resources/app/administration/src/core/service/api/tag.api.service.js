    ...
    async merge(ids, name, definitionProperties, bulkMergeProgress) {
        ...
        for (const [
            ...
            do {
                ...
                // eslint-disable-next-line
                const { data, total } = await repository.searchIds(criteria, Shopwell.Context.api);
        ...
        await tagRepository.syncDeleted(ids, Shopwell.Context.api);
    }

    getRepository(entity) {
        return Shopwell.Service('repositoryFactory').create(entity);
    }
}
