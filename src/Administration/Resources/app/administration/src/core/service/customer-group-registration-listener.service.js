const { Application, Service, Store } = Shopwell;
...
export default function addCustomerGroupRegistrationListener(loginService) {
    ...
    async function checkForUpdates() {
        if (!Shopwell.Service('acl').can('customer.viewer')) {
            return;
        }
        ...
        const customers = await customerRepository.search(criteria, Shopwell.Context.api);
