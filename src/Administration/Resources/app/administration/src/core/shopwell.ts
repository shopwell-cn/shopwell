...
class ShopwellClass implements CustomShopwellProperties {
    /**
     * @private
     */
    ...
    public Component = {
        ...
        registerOverrideComponent: (component: DefineComponent<unknown, unknown, unknown>) => {
            ShopwellClass.#overrideComponents.value.push(component);
        },
        /**
         * @experimental stableVersion:v6.8.0 feature:ADMIN_COMPOSITION_API_EXTENSION_SYSTEM
         */
        getOverrideComponents: () => {
            return ShopwellClass.#overrideComponents.value;
        },
    };
    ...
    public get Snippet() {
        ...
        if (!Shopwell.Application.view?.i18n) {
            return null;
        }

        return {
            // @ts-expect-error - type is currently not available
            ...Shopwell.Application.view.i18n.global,
            // @ts-expect-error - type is currently not available
            tc: Shopwell.Application.view.i18n.global.t,
        };
    }
    ...
    public Constants: CustomShopwellConstants = {
        CMS: CMS,
        CUSTOMER: CUSTOMER,
        FLOW: FLOW,
    } as CustomShopwellConstants;
...
const ShopwellInstance = new ShopwellClass();

// Freeze InAppPurchase to prevent modifications
Object.defineProperty(ShopwellInstance, 'InAppPurchase', { configurable: false, writable: false });

// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export { ShopwellClass, ShopwellInstance };
