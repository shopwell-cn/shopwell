 ...
 *
 * @module core/data/ShopwellError
 */
 ...
 * @memberOf module:core/data/ShopwellError
 */
// eslint-disable-next-line sw-deprecation-rules/private-feature-declarations
export default class ShopwellError {
    ...
    constructor({
        ...
        if (typeof code !== 'string' || code === '') {
            throw new Error('[ShopwellError] can not identify error by code');
        }
