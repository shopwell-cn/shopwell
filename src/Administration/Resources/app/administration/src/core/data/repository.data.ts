...
export default class Repository<EntityName extends keyof EntitySchema.Entities> {
    ...
    get schema(): EntityDefinition<any> {
        return Shopwell.EntityDefinition.get(this.entityName);
    }

    /**
     * Sends a search request to the server to find entity ids for the provided criteria.
     */
    searchIds(criteria: Criteria, context = Shopwell.Context.api): Promise<IdSearchResult> {
     ...
     */
    search(criteria: Criteria, context = Shopwell.Context.api): Promise<EntityCollection<EntityName>> {
        const headers = this.buildHeaders(context);
     ...
     */
    get(id: string, context = Shopwell.Context.api, criteria: Criteria | null = null): Promise<Entity<EntityName> | null> {
     ...
     */
    save(entity: Entity<EntityName>, context = Shopwell.Context.api): Promise<void | AxiosResponse> {
     ...
     */
    clone(entityId: string, behavior: $TSDangerUnknownObject, context = Shopwell.Context.api): Promise<unknown> {
        if (!entityId) {
     ...
     */
    saveAll(entities: EntityCollection<EntityName>, context = Shopwell.Context.api): Promise<unknown> {
     ...
     * @private
     */
    sendUpserts(changeset: $TSDangerUnknownObject[], failOnError: boolean, context = Shopwell.Context.api): Promise<void> {
     ...
     */
    assign(id: string, context = Shopwell.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    delete(id: string, context = Shopwell.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    syncDeleted(ids: string[], context = Shopwell.Context.api): Promise<void> {
        const headers = this.buildHeaders(context);
     ...
     */
    create(context = Shopwell.Context.api, id: string | null = null): Entity<EntityName> {
     ...
     */
    mergeVersion(versionId: string, context = Shopwell.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    deleteVersion(entityId: string, versionId: string, context = Shopwell.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    sendDeletions(queue: DeletionQueue, context = Shopwell.Context.api): Promise<AxiosResponse[]> {
        const headers = this.buildHeaders(context);
     ...
     */
    buildHeaders(context = Shopwell.Context.api): {
        Accept: string;
