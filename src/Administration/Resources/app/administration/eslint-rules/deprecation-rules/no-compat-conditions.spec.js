...
yetAnotherThing();
      ...
      `,
        ...
        const obj = {
          sliderLength() {
              const children = Shopwell.Utils.VueHelper.getCompatChildren();
...
return true;
      ...
      `,
        ...
        const children = this.isCompatEnabled('INSTANCE_CHILDREN')
                ? this.$children
                : Shopwell.Utils.VueHelper.getCompatChildren();
      `,
            output: `
        const children = Shopwell.Utils.VueHelper.getCompatChildren();
      `,
        ...
        },
        {
            ...
            code: `const children = this.isCompatEnabled('INSTANCE_CHILDREN') ? this.$children : Shopwell.Utils.VueHelper.getCompatChildren();`,
            output: `const children = Shopwell.Utils.VueHelper.getCompatChildren();`,
            errors: [{ message: 'Feature flag condition should be removed' }],
        },
        {
