...
export default {
    ...
    computed: {
        ...
        isShopwellDefaultTax() {
            return this.$te(\`global.tax-rates.\${this.tax.name}\`, 'en-GB');
        },

        label() {
            return this.isShopwellDefaultTax ? this.$tc(\`global.tax-rates.\${this.tax.name}\`) : this.tax.name;
        },
    ...
    methods: {
        ...
        onChangeLanguage(languageId) {
            Shopwell.State.commit('context/setApiLanguageId', languageId);
            this.createdComponent();
        },
...
'            };\n' +
'        });\n' +
'          const isShopwellDefaultTax = computed(() => {\n' +
"            return this.$te(`global.tax-rates.${tax.name}`, 'en-GB');\n" +
'        });\n' +
'          const label = computed(() => {\n' +
'            return isShopwellDefaultTax.value ? this.$tc(`global.tax-rates.${tax.name}`) : tax.name;\n' +
'        });\n' +
...
const { Mixin, Data: { Criteria } } = Shopwell;
