...
const getAsyncExpressionName = (node) => {
    // Shopwell.Component.build
    if (node.callee?.object?.object?.name === 'Shopwell' && node.callee?.object?.property?.name === 'Component' && node.callee?.property?.name === 'build') {
        return 'Shopwell.Component.build';
    }
