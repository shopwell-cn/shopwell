...
Component.register('sw-theme-manager-list', {
    ...
    methods: {
        ...
        getList() {
            ...
            return this.themeRepository.search(criteria, Shopwell.Context.api).then((searchResult) => {
        ...
        onChangeLanguage(languageId) {
            Shopwell.Context.api.languageId = languageId;
            this.resetList();
        },
        ...
        saveTheme(theme) {
            this.isLoading = true;
            return this.themeRepository.save(theme, Shopwell.Context.api).then(() => {
                this.isLoading = false;
            }).catch(() => {
                this.isLoading = false;
            });
