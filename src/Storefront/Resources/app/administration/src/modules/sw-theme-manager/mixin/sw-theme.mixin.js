...
Mixin.register('theme', {
    ...
    methods: {
        ...
        deleteTheme(theme) {
            ...
            this.isLoading = true;
            this.themeRepository.delete(theme.id, Shopwell.Context.api).then(() => {
                if (this.getList) {
                    this.getList();
                    return;
                }
        ...
        duplicateTheme(parentTheme, name) {
            const themeDuplicate = this.themeRepository.create(Shopwell.Context.api);
            ...
            this.themeRepository.save(themeDuplicate, Shopwell.Context.api).then(() => {
        ...
        RenameTheme(theme, name) {
            ...
            this.themeRepository.save(theme, Shopwell.Context.api);
        }
    }
});
