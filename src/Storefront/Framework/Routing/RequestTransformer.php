...
class RequestTransformer implements RequestTransformerInterface
{
    ...
    public function transform(Request $request): Request
    {
        ...
        /**
         * - Remove "virtual" suffix of domain mapping shopwell.de/de
         * - To get only the host shopwell.de as real request uri shopwell.de/
         * - Resolve remaining seo url and get the real path info shopwell.de/outdoor => shopwell.de/navigation/{id}
         *
         * Possible domains
         *
