...
#[Package('checkout')]
#[Entity(WalletWithdrawMethodEntity::ENTITY_NAME, since: '6.8.0.0', collectionClass: WalletWithdrawMethodCollection::class)]
class WalletWithdrawMethodEntity extends EntityStruct
{
