...
use Shopwell\Core\Checkout\Promotion\Gateway\Template\PermittedGlobalCodePromotions;
use Shopwell\Core\Checkout\Promotion\Gateway\Template\PermittedIndividualCodePromotions;
