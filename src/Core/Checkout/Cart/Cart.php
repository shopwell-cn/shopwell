...
class Cart extends Struct
{
     ...
     * The `\Shopwell\Core\Checkout\Cart\Processor::process` will set this
     */
    ...
    /**
     * @internal These function is reserved for the `\Shopwell\Core\Checkout\Cart\Processor::process`
     */
