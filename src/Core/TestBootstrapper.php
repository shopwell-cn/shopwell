...
class TestBootstrapper
{
    ...
    public function addCallingPlugin(?string $pathToComposerJson = null): TestBootstrapper
    {
        ...
        $baseClass = $composer['extra']['shopwell-plugin-class'] ?? '';
        if ($baseClass === '') {
            throw new \RuntimeException('composer.json does not contain `extra.shopwell-plugin-class`. Path: ' . $pathToComposerJson);
        }
