...
use Shopwell\Core\Content\Media\Core\Event\MediaLocationEvent;
 ...
 * @codeCoverageIgnore
 *
 * @see \Shopwell\Tests\Integration\Core\Content\Media\Infrastructure\Path\MediaLocationBuilderTest
 */
#[Package('discovery')]
