 ...
 * @internal
 *
 *  * @codeCoverageIgnore This would be useless as a unit test. It is integration tested here: \Shopwell\Tests\Integration\Core\Content\Media\Subscriber\CustomFieldsUnusedMediaSubscriberTest
 */
#[Package('discovery')]
