...
namespace Shopwell\Core\Content\ProductExport\Api;
...
use Shopwell\Core\Content\ProductExport\Exception\SalesChannelDomainNotFoundException;
use Shopwell\Core\Content\ProductExport\Exception\SalesChannelNotFoundException;
