...
{
    final public const string CONTENT_IMPORT_EXPORT_COULD_NOT_OPEN_FILE = 'CONTENT__IMPORT_EXPORT__COULD_NOT_OPEN_FILE';
    final public const string CONTENT_IMPORT_EXPORT_COULD_NOT_CREATE_FILE = 'CONTENT__IMPORT_EXPORT__COULD_NOT_CREATE_FILE';
    final public const string CONTENT_IMPORT_EXPORT_COULD_NOT_COPY_FILE = 'CONTENT__IMPORT_EXPORT__COULD_NOT_COPY_FILE';
    final public const string CONTENT_IMPORT_EXPORT_COULD_NOT_WRITE_TO_BUFFER = 'CONTENT__IMPORT_EXPORT__COULD_NOT_WRITE_TO_BUFFER';
    public const string FIELD_CANNOT_BE_EXPORTED = 'IMPORT_EXPORT__FIELD_CANNOT_BE_EXPORTED';
    final public const string FAILED_MEDIA_URL_PARSE = 'IMPORT_EXPORT__FAILED_MEDIA_URL_PARSE';
    final public const string MEDIA_FOLDER_NOT_FOUND = 'IMPORT_EXPORT__MEDIA_FOLDER_NOT_FOUND';
    public const string FILE_EMPTY = 'CONTENT__IMPORT_EXPORT_FILE_EMPTY';
    public const string FILE_NOT_READABLE = 'CONTENT__IMPORT_FILE_IS_NOT_READABLE';
    public const string INVALID_FILE_CONTENT = 'CONTENT__IMPORT_EXPORT_INVALID_FILE_CONTENT';
    public const string LOG_ENTITY_NOT_FOUND = 'CONTENT__IMPORT_EXPORT__LOG_ENTITY_NOT_FOUND';
    public const string PROFILE_WITHOUT_MAPPINGS = 'CONTENT__IMPORT_EXPORT_PROFILE_WITHOUT_MAPPINGS';
    public const string PROFILE_WRONG_TYPE = 'CONTENT__IMPORT_EXPORT_PROFILE_WRONG_TYPE';
    public const string UNEXPECTED_FILE_TYPE = 'CONTENT__IMPORT_FILE_HAS_UNEXPECTED_TYPE';
    public const string UNKNOWN_ACTIVITY = 'CONTENT__IMPORT_EXPORT__UNKNOWN_ACTIVITY';
    public const string FILE_PATH_NOT_FOUND = 'CONTENT__IMPORT_EXPORT__FILE_PATH_NOT_FOUND';
    public const string INVALID_REQUEST_PARAMETER = 'CONTENT__IMPORT_EXPORT__INVALID_REQUEST_PARAMETER';
    public const string MISSING_PRIVILEGE = 'CONTENT__IMPORT_EXPORT__MISSING_PRIVILEGE';
    final public const string PROFILE_SEARCH_EMPTY = 'CONTENT__IMPORT_EXPORT__PROFILE_SEARCH_EMPTY';
    final public const string IMPORT_COMMAND_FAILED = 'CONTENT__IMPORT_EXPORT__COMMAND_FAILED';
    final public const string DUPLICATE_TECHNICAL_NAME = 'CONTENT__IMPORT_EXPORT__DUPLICATE_TECHNICAL_NAME';
    final public const string DESERIALIZE_FAILED = 'CONTENT__IMPORT_EXPORT__DESERIALIZE_FAILED';

    final public const string INVALID_INSTANCE_TYPE = 'CONTENT__IMPORT_EXPORT__INVALID_INSTANCE_TYPE';
    final public const string SERIALIZER_NOT_FOUND = 'CONTENT__IMPORT_EXPORT__SERIALIZER_NOT_FOUND';
    final public const string UPDATE_ENTITY_NOT_FOUND = 'CONTENT__IMPORT_EXPORT__UPDATE_ENTITY_NOT_FOUND';
