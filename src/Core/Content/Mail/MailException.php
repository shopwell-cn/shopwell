...
class MailException extends HttpException
{
     ...
     */
    public static function givenSendMailOptionIsInvalid(string $option, array $validOptions): ShopwellHttpException
    {
        return new self(
    ...
    public static function givenMailAgentIsInvalid(string $agent): ShopwellHttpException
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
    ...
    public static function mailBodyTooLong(int $maxContentLength): ShopwellHttpException
    {
        return new self(
