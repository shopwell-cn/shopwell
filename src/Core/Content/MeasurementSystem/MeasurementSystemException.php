...
{
    public const string UNSUPPORTED_MEASUREMENT_SYSTEM = 'CONTENT_UNSUPPORTED_MEASUREMENT_SYSTEM_TYPE';

    public const string UNSUPPORTED_MEASUREMENT_UNIT = 'CONTENT_UNSUPPORTED_MEASUREMENT_SYSTEM_UNIT';

    public const string INCOMPATIBLE_MEASUREMENT_UNITS = 'CONTENT_INCOMPATIBLE_MEASUREMENT_UNITS';

    public const string MEASUREMENT_UNIT_CANT_HAVE_ZERO_FACTOR = 'CONTENT_MEASUREMENT_UNIT_CANT_HAVE_ZERO_FACTOR';
