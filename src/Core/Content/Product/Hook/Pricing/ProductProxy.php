...
class ProductProxy implements \ArrayAccess
{
    ...
    /**
     * The `__get()` function allows access to all properties of the [SalesChannelProductEntity](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Content/Product/SalesChannel/SalesChannelProductEntity.php)
     *
