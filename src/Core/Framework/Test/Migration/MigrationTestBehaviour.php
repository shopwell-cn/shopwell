...
namespace Shopwell\Core\Framework\Test\Migration;
    ...
    public function addMigrationSources(): void
    {
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_invalid_namespace' => 'Shopwell\Core\Framework\Test\Migration\_test_migrations_invalid_namespace']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid' => 'Shopwell\Core\Framework\Test\Migration\_test_migrations_valid']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time' => 'Shopwell\Core\Framework\Test\Migration\_test_migrations_valid_run_time']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time_exceptions' => 'Shopwell\Core\Framework\Test\Migration\_test_migrations_valid_run_time_exceptions']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_trigger_with_trigger_' => 'Shopwell\Core\Framework\Test\Migration\_test_trigger_with_trigger_']
            )
        );
