...
class TestBrowser extends KernelBrowser
{
     ...
     *
     * Shopwell often wants to use that accept header with a value of `application/vnd.api+json,application/json`
     * see e.g. \Shopwell\Core\Framework\Test\TestCaseBase\AdminApiTestBehaviour::createClient
     *
