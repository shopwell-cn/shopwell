...
namespace Shopwell\Core\Framework\Plugin\Command\Lifecycle;
...
abstract class AbstractPluginLifecycleCommand extends Command
{
    ...
    protected function prepareExecution(
        ...
        $io->title('Shopwell Plugin Lifecycle Service');
    ...
    protected function handleClearCacheOption(InputInterface $input, ShopwellStyle $io, string $action): void
    {
