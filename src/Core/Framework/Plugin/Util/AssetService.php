...
use Shopwell\Core\Framework\Adapter\Filesystem\Plugin\CopyBatch;
use Shopwell\Core\Framework\Adapter\Filesystem\Plugin\CopyBatchInput;
    ...
    private function sync(string $originDir, string $targetDirectory, array $localManifest, array $remoteManifest): void
    {
        ...
        foreach ($uploads as $file) {
            $batches[] = new CopyBatchInput(
                ...
                $this->parameterBag->get('shopwell.filesystem.asset.config')['visibility'] ?? Visibility::PUBLIC,
            );
        }
