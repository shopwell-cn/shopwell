...
class MacroOverrideNode extends MacroNode
{
    public function compile(Compiler $compiler): void
    {
        ...
        $compiler
            ...
            ->write("if (\Shopwell\Core\Framework\Adapter\Twig\SwTwigFunction::\$macroResult !== null) {\n")
            ->write('$result = \Shopwell\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult;' . "\n")
            ->write('\Shopwell\Core\Framework\Adapter\Twig\SwTwigFunction::$macroResult = null;' . "\n")
            ->write("}\n")
            ->write("return \$result;\n")
