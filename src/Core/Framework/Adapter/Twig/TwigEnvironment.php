...
class TwigEnvironment extends Environment
{
    ...
    public function compile(Node $node): string
    {
        ...
        $replaces = [
            'CoreExtension::getAttribute(' => '\Shopwell\Core\Framework\Adapter\Twig\SwTwigFunction::getAttribute(',
            'twig_escape_filter(' => '\Shopwell\Core\Framework\Adapter\Twig\SwTwigFunction::escapeFilter(',
        ];
