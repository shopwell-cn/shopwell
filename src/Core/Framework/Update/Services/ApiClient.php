...
namespace Shopwell\Core\Framework\Update\Services;
...
class ApiClient
{
    ...
    public function __construct(
        ...
        private readonly bool $shopwellUpdateEnabled,
    ...
    public function checkForUpdates(): Version
    {
        ...
        try {
            ...
            $github = $this->client->request('GET', 'https://releases.shopwell.com/changelog/' . $this->determineLatestShopwellVersion() . '.json')->toArray();
    ...
    public function downloadRecoveryTool(): void
    {
        ...
        $content = $this->client->request('GET', 'https://github.com/shopwell/web-installer/releases/latest/download/shopwell-installer.phar.php')->getContent();
    ...
    private function determineLatestShopwellVersion(): string
    {
        ...
        $versions = $this->client->request('GET', 'https://releases.shopwell.com/changelog/index.json')->toArray();
