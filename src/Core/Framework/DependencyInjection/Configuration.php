...
use Shopwell\Core\Framework\Util\MemorySizeCalculator;
...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('shopwell');
        ...
        $rootNode
            ->children()
                ...
                ->booleanNode('enable_queue_stats_worker')
                    ->setDeprecated('shopwell/core', '6.8.0', 'The "%node%" option is deprecated and will be removed in 6.8.0. The increment-based message queue statistics will be removed, please use "shopwell.messenger.stats.enabled" as alternative.')
                    ->defaultValue(true)
                ->end()
                ...
                ->arrayNode('invalidation')
                    ->children()
                        ...
                        ->arrayNode('http_cache')
                            ->setDeprecated('shopwell/core', '6.8.0', 'The "%node%" option is deprecated and will be removed in 6.8.0 as cache states will be removed.')
                            ->performNoDeepMerging()
                            ->prototype('scalar')->end()
                        ->end()
                        ...
                        ->arrayNode('product_listing_route')
                            ->setDeprecated('shopwell/core', '6.8.0', 'The "%node%" option is deprecated and will be removed in 6.8.0 as it has no effect anymore.')
                            ->performNoDeepMerging()
                            ->prototype('scalar')->end()
                        ->end()
    ...
    private function createHttpCacheSection(): ArrayNodeDefinition
    {
        ...
        $rootNode
                ...
                ->arrayNode('reverse_proxy')
                    ->children()
                        ...
                        ->booleanNode('use_varnish_xkey')
                            ->setDeprecated('shopwell/core', '6.8.0', 'The "%node%" option has no effect anymore and therefore will be removed in 6.8.0.')
                            ->defaultFalse()
                        ->end()
            ...
            ->validate()
                ...
                ->thenInvalid('Configuration references unknown cache policies. All policy names in default_policies and route_policies must be defined under shopwell.http_cache.policies.')
            ->end()
        ->end();
