...
{
    private const array MAJOR_VERSIONS = ['V6_3', 'V6_4', 'V6_5', 'V6_6', 'V6_7', 'V6_8'];
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        foreach (self::MAJOR_VERSIONS as $major) {
            ...
            if (\is_dir($versionedMigrationPath)) {
                ...
                $migrationSource->addMethodCall('addDirectory', [$versionedMigrationPath, 'Shopwell\\' . $this->getMigrationNamespacePart() . '\Migration\\' . $major]);
            }
        }
    }
