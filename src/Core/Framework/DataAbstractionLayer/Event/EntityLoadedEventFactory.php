...
use Shopwell\Core\System\SalesChannel\Entity\PartialSalesChannelEntityLoadedEvent;
...
class EntityLoadedEventFactory
{
    ...
    public function createForSalesChannel(array $entities, SalesChannelContext $context): array
    {
        ...
        $salesGenerator = static fn (EntityDefinition $definition, array $entities) => new SalesChannelEntityLoadedEvent($definition, $entities, $context);
    ...
    public function createPartialForSalesChannel(array $entities, SalesChannelContext $context): array
    {
        ...
        $salesGenerator = static fn (EntityDefinition $definition, array $entities) => new PartialSalesChannelEntityLoadedEvent($definition, $entities, $context);
