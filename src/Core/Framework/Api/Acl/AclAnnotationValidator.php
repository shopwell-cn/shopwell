...
class AclAnnotationValidator implements EventSubscriberInterface
{
    ...
    public function validate(ControllerEvent $event): void
    {
        ...
        foreach ($privileges as $privilege) {
            /** special acl annotation for @see \Shopwell\Core\Framework\App\Api\AppActionController::runAction */
            if ($privilege === 'app') {
    ...
    {
        /** special case for @see \Shopwell\Core\Framework\App\Api\AppActionController::runAction */
