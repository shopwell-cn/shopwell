...
The OpenAPI specification for the StoreAPI is generated by the `Shopwell\Core\Framework\Api\ApiDefinition\Generator\StoreApiGenerator`. This generator builds the final schema by merging information from the next sources:
