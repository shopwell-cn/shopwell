...
use Shopwell\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
...
{
    final public const string WRITE_UPDATE = 'update';
    final public const string WRITE_CREATE = 'create';
    final public const string WRITE_DELETE = 'delete';
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Shopwell\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \Shopwell\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \Shopwell\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Shopwell\Core\Content\Category\CategoryDefinition
             */
