 ...
 *
 * @phpstan-import-type ErrorData from ShopwellHttpException as ShopwellExceptionData
 */
#[Package('framework')]
class ErrorResponseFactory
{
    ...
    /**
     * @return array<DefaultExceptionData|ShopwellExceptionData>
     */
    ...
    private function getStatusCodeFromException(\Throwable $exception): int
    {
        ...
        if ($exception instanceof ShopwellHttpException || $exception instanceof HttpException) {
