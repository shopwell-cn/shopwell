...
use Shopwell\Core\Framework\Migration\Exception\UnknownMigrationSourceException;
use Symfony\Component\HttpFoundation\Response;

#[Package('framework')]
class MigrationException extends HttpException
{
    final public const string FRAMEWORK_MIGRATION_INVALID_VERSION_SELECTION_MODE = 'FRAMEWORK__MIGRATION_INVALID_VERSION_SELECTION_MODE';
    final public const string FRAMEWORK_MIGRATION_INVALID_MIGRATION_SOURCE = 'FRAMEWORK__INVALID_MIGRATION_SOURCE';
    final public const string FRAMEWORK_MIGRATION_IMPLAUSIBLE_CREATION_TIMESTAMP = 'FRAMEWORK__MIGRATION_IMPLAUSIBLE_CREATION_TIMESTAMP';
    final public const string MIGRATION_COULD_NOT_DETERMINE_TIMESTAMP = 'FRAMEWORK__MIGRATION_COULD_NOT_DETERMINE_TIMESTAMP';
    final public const string FRAMEWORK_MIGRATION_PLUGIN_COULD_NOT_BE_FOUND = 'FRAMEWORK__MIGRATION_PLUGIN_COULD_NOT_BE_FOUND';
    final public const string FRAMEWORK_MIGRATION_MORE_THAN_ONE_PLUGIN_FOUND = 'FRAMEWORK__MIGRATION_MORE_THAN_ONE_PLUGIN_FOUND';
    final public const string FRAMEWORK_MIGRATION_DIRECTORY_COULD_NOT_BE_CREATED = 'FRAMEWORK__MIGRATION_DIRECTORY_COULD_NOT_BE_CREATED';
    final public const string INVALID_ARGUMENT = 'FRAMEWORK__MIGRATION_INVALID_ARGUMENT_EXCEPTION';
    final public const string MIGRATION_ERROR = 'FRAMEWORK__MIGRATION_ERROR';
    final public const string INVALID_MIGRATION = 'FRAMEWORK__INVALID_MIGRATION';
    final public const string MIGRATION_MULTI_COLUMN_PRIMARY_KEY = 'FRAMEWORK__MIGRATION_MULTI_COLUMN_PRIMARY_KEY';
    final public const string MIGRATION_NO_PRIMARY_KEY = 'FRAMEWORK__MIGRATION_NO_COLUMN_PRIMARY_KEY';
    final public const string LOGIC_ERROR = 'FRAMEWORK__LOGIC_ERROR';
    final public const string MIGRATION_FILE_DOES_NOT_EXIST = 'FRAMEWORK__MIGRATION_FILE_DOES_NOT_EXIST';
