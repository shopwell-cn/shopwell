...
class RefreshAppCommand extends Command
{
    ...
    private function validateRefreshableApps(RefreshableAppDryRun $refreshableApps, ShopwellStyle $io, Context $context): int
    {
    ...
    private function grantPermissions(RefreshableAppDryRun $refreshableApps, ShopwellStyle $io): void
    {
        $default = true;
    ...
    private function grantPermissionsForApp(Manifest $app, ShopwellStyle $io, bool $install = true): void
    {
