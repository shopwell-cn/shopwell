...
namespace Shopwell\Core\Framework\Gateway;
...
{
    public const string EMPTY_APP_RESPONSE_CODE = 'CONTEXT_GATEWAY__EMPTY_APP_RESPONSE';
    public const string PAYLOAD_INVALID_CODE = 'CONTEXT_GATEWAY__PAYLOAD_INVALID';
    public const string HANDLER_NOT_FOUND_CODE = 'CONTEXT_GATEWAY__HANDLER_NOT_FOUND';
    public const string HANDLER_EXCEPTION = 'CONTEXT_GATEWAY__HANDLER_EXCEPTION';
    public const string COMMAND_VALIDATION_FAILED = 'CONTEXT_GATEWAY__COMMAND_VALIDATION_FAILED';
    public const string REQUEST_FAILED = 'CONTEXT_GATEWAY__REQUEST_FAILED';
    public const string CUSTOMER_MESSAGE = 'CONTEXT_GATEWAY__CUSTOMER_MESSAGE';
