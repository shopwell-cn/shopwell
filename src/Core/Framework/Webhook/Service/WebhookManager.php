...
use Shopwell\Core\Framework\Webhook\Event\PreWebhooksDispatchEvent;
    ...
    private function callWebhooksSynchronous(
        ...
        foreach ($webhooksForEvent as $webhook) {
            ...
            $headers = [
                ...
                AuthMiddleware::SHOPWELL_CONTEXT_LANGUAGE => $languageId,
                AuthMiddleware::SHOPWELL_USER_LANGUAGE => $userLocale,
            ];
