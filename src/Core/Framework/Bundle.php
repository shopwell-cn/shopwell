...
use Shopwell\Core\Framework\Adapter\Filesystem\PrefixFilesystem;
...
abstract class Bundle extends SymfonyBundle
{
    ...
    /**
     * Returns a list of all action event class references of this bundle. The events will be registered inside the `\Shopwell\Core\Framework\Event\BusinessEventRegistry`.
     *
