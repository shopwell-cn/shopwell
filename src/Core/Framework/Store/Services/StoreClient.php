...
use Shopwell\Core\Framework\Store\Struct\LicenseStruct;
...
use Shopwell\Core\Framework\Store\Struct\StoreActionStruct;
use Shopwell\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
use Shopwell\Core\Framework\Store\Struct\StoreLicenseViolationTypeStruct;
use Shopwell\Core\Framework\Store\Struct\StoreUpdateStruct;
...
class StoreClient
{
    ...
    public function logout(Context $context): void
    {
        ...
        $this->eventDispatcher->dispatch(new ShopwellAccountLogoutEvent($context));
    }
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureShopwellVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    {
        return $this->instanceService->getShopwellVersion();
    }
