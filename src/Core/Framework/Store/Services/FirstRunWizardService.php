...
{
    final public const string USER_CONFIG_KEY_FRW_USER_TOKEN = 'core.frw.userToken';
    final public const string USER_CONFIG_VALUE_FRW_USER_TOKEN = 'frwUserToken';

    private const string TRACKING_EVENT_FRW_STARTED = 'First Run Wizard started';
    private const string TRACKING_EVENT_FRW_FINISHED = 'First Run Wizard finished';

    private const int FRW_MAX_FAILURES = 3;
