...
use Shopwell\Core\Framework\App\ShopIdChangeResolver\AbstractShopIdChangeStrategy;
...
class DecorationPatternRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        // only validate classes that extend from abstract Shopwell classes
        if (!$parent || !\str_starts_with($parent->getName(), 'Shopwell\\') || !$parent->isAbstract()) {
            return [];
        }
