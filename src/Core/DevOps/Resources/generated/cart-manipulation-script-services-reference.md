...
## [services.cart (`Shopwell\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference#discountfacade)
...
* **Examples:**
    * Add an absolute discount to the cart.
        ...
        ```twig
        {# @var services \Shopwell\Core\Framework\Script\ServiceStubs #}
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference#errorsfacade)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade) | `null`
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference#itemsfacade)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference#cartpricefacade)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference#productsfacade)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference#statesfacade)
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Returns** [`Shopwell\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
* **Returns** `float`
    ...
    The rounded total price of the cart as float.
_________
## [`Shopwell\Core\Checkout\Cart\Facade\ContainerFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/ContainerFacade.php) {#containerfacade}
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)

    The item that was added to the container.
* **Arguments:**
    * *[`Shopwell\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The item that should be added.
* **Examples:**
...
* **Returns** [`Shopwell\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference#arrayfacade)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference#pricefacade) | `null`
...
* **Examples:**
    * Take a quantity of 2 from an existing product line-item and add it to the cart again.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
_________
## [`Shopwell\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Error\Error`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
* **Examples:**
    * Add a warning to the cart.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
* **Examples:**
    * Take a quantity of 2 from an existing product line-item and add it to the cart again.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Arguments:**
    * *[`Shopwell\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Arguments:**
    * *[`Shopwell\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)* **price**: The provided price can be a fetched price from the database or generated over the `PriceFactory` statically
* **Examples:**
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Tax\Struct\TaxRuleCollection`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/TaxRuleCollection.php)
...
* **Returns** [`Shopwell\Core\Checkout\Cart\Tax\Struct\CalculatedTaxCollection`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/CalculatedTaxCollection.php)
...
* **Examples:**
    * Adds a 10% surcharge to the existing calculated price
        ...
        ```
_________
## [services.price (`Shopwell\Core\Checkout\Cart\Facade\PriceFactory`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFactory.php) {#pricefactory}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`Shopwell\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
