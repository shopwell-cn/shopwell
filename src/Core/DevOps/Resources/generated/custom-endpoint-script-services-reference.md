...
## [services.cache (`Shopwell\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        ```
_________
## [services.writer (`Shopwell\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}
...
* **Returns** [`Shopwell\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`Shopwell\Core\Framework\Api\Sync\SyncResult`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    ...
    * Update an existing entity.
        ...
        ```
_________
## [services.response (`Shopwell\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
...
* **Returns** [`Shopwell\Core\Framework\Script\Api\ScriptResponse`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/Script/Api/ScriptResponse.php)
