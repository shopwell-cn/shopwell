...
## [services.repository (`Shopwell\Core\Framework\DataAbstractionLayer\Facade\RepositoryFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryFacade.php) {#repositoryfacade}
...
* **Returns** [`Shopwell\Core\Framework\DataAbstractionLayer\Search\AggregationResult\AggregationResultCollection`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/AggregationResult/AggregationResultCollection.php)
...
* **Examples:**
    * Aggregate data for multiple entities, e.g. the sum of the gross price of all products.
        ...
        ```twig
        {% set page = hook.page %}
		{# @var page \Shopwell\Storefront\Page\Page #}
...
* **Returns** [`Shopwell\Core\Framework\DataAbstractionLayer\Search\IdSearchResult`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/IdSearchResult.php)
...
* **Returns** [`Shopwell\Core\Framework\DataAbstractionLayer\Search\EntitySearchResult`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/EntitySearchResult.php)
...
* **Examples:**
    ...
    * Add associations that should be included in the result.
        ...
        ```
_________
## [services.store (`Shopwell\Core\Framework\DataAbstractionLayer\Facade\SalesChannelRepositoryFacade`)](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/SalesChannelRepositoryFacade.php) {#saleschannelrepositoryfacade}
