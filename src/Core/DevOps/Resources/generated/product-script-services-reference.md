...
## [`Shopwell\Core\Content\Product\Hook\Pricing\CheapestPriceFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Content/Product/Hook/Pricing/CheapestPriceFacade.php) {#cheapestpricefacade}
...
* **Examples:**
    * Adds a 10% surcharge to the existing calculated price
        ...
        ```
_________
## [`Shopwell\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Content/Product/Hook/Pricing/PriceCollectionFacade.php) {#pricecollectionfacade}
...
_________
## [`Shopwell\Core\Content\Product\Hook\Pricing\ProductProxy`](https://github.com/shopwell/shopwell/blob/trunk/src/Core/Content/Product/Hook/Pricing/ProductProxy.php) {#productproxy}
...
* **Returns** [`Shopwell\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](./product-script-services-reference#pricecollectionfacade) | `null`
