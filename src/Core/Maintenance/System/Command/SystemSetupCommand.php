...
class SystemSetupCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (\is_file($this->projectDir . '/symfony.lock')) {
            $io->warning('It looks like you have installed Shopwell with Symfony Flex. You should use a .env.local file instead of creating a complete new one');
        }

        $io->title('Shopwell setup process');
